...
## 🔥LTG150: Microsoft Agent Framework for next-gen multi-agent solution
...
Explore Microsoft’s new open-source Agent Framework—merging Semantic Kernel and AutoGen into one SDK. See how it simplifies building, orchestrating, and scaling multi-agent workflows from prototype to production.

### 🧠 Learning Outcomes

By the end of this session, learners will be able to:

-  Understand the architecture and components of the Microsoft Agent Framework.
-  Build multi-agent solutions using the framework.
-  Leverage the framework's capabilities for orchestration and scaling.
...
| Microsoft Agent Framework GitHub Repository | [https://aka.ms/AgentFramework](https://aka.ms/AgentFramework) | Main repository for the Microsoft Agent Framework |
| Microsoft Agent Framework Docs | [https://aka.ms/AgentFramework/Docs](https://aka.ms/AgentFramework/Docs) | Official documentation for the Microsoft Agent Framework |
...
<table>
<tr>
    <td align="center"><a href="http://github.com/takuto100426">
        <img src="https://github.com/takuto100426.png" width="100px;" alt="Takuto Higuchi"/><br />
        <sub><b>Takuto Higuchi
</b></sub></a><br />
            <a href="https://github.com/e-straight" title="talk">📢</a> 
    </td>
    <td align="center"><a href="http://github.com/e-straight">
        <img src="https://github.com/e-straight.png" width="100px;" alt="Elijah Straight
"/><br />
        <sub><b>Elijah Straight
</b></sub></a><br />
            <a href="https://github.com/e-straight" title="talk">📢</a> 
    </td>
</tr></table>
